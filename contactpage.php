...
if ($_SERVER['REQUEST_METHOD'] === "POST") {
  ...
  if (empty($errors)) {
    ...
    <br>
    Selected Location: <span style=\"color:#888\">$option\n</span>
    <br>
    Enquired Country: <span style=\"color:#888\">$option1\n</span>
    <br>
    ...
    $headers = 	'From: Contact Page Form <admin@destinex.net>' . "\r\n" .
    "Reply-To: $email" . "\r\n" .
    "MIME-Version: 1.0\r\n" . 
    "Content-Type: text/html; charset=iso-8859-1\r\n";

    $to = 'mbbsadmissionsinabroad@gmail.com';
    $subject = 'New Entry From Contact Page Form';
